...
if exists('g:lightline')
  ...
  let s:p.insert.left = [ [ s:bg0, s:orange, 'bold' ], [ s:fg1, s:bg2 ] ]
  let s:p.insert.right = [ [ s:bg0, s:orange], [ s:fg1, s:bg2 ] ]
  ...
  let s:p.visual.left = [ [ s:bg0, s:blue, 'bold' ], [ s:bg0, s:bg4 ] ]
  let s:p.visual.right = [ [ s:bg0, s:blue], [ s:bg0, s:bg4 ] ]
